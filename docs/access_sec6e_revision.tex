...
5^\circ$, envelope alone) $305$ of $308$ runs sit inside; the three
exceedances all lie on the two cases whose injected offsets ---
$(32,32)$ and $(38,14)$ mm --- sit at or beyond the design
rectangle assumed by $\rbar$, the worst of them at the fastest ramp
on the shortest window the campaign gate admits --- the certificate
fails exactly where its own premise does. On hardware
($\varphi_{\max} = 8^\circ$, envelope plus (98)) all $140$ runs sit
inside, the worst using $0.81$ of its cap. The median used fraction
