...
Both are monotone decreasing in between (checked numerically), so the
small-$x$ values are the maxima:
\begin{equation}
  ...
  \tag{95}
\end{equation}
Over the flown $x\in[1.79,5.20]$ they run $0.089$--$0.133$ and
$0.145$--$0.191$, i.e.\ a factor of $5$ to $11$ off (D.3).
