...
combine to $S_2/S_0$. Cauchy--Schwarz applied to the two sequences
$\bigl\{\sqrt{a_nu^n}\bigr\}$ and $\bigl\{n\sqrt{a_nu^n}\bigr\}$ ---
legitimate because $a_nu^n\ge0$, which is the only place the sign
pattern is needed --- gives $S_1^2\le S_0S_2$. Hence
...
shift $u\Lambda$, and neither is a monomial. So $n_{\rm eff}$ is
strictly increasing for both channels and $R$ is strictly decreasing.
The same weights give the origin values for free, since as $u\to0$ they
concentrate on the lowest exponent present, $6$ and $4$.
