...
\textbf{Proof of (D.11).} The same Lemma settles the ground-effect
...
the Lemma gives $E\ge0$, which is (D.11). $\square$

No series is needed for either, and (D.11) costs one application of the
Lemma against three for (D.10) --- the completed square in (D.12) does
