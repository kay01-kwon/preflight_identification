...
\textbf{Proof of (D.10).} Let $D(x)$ be the difference of the two
sides, $D(0) = 0$. Differentiating and factoring out $\Lambda>0$,
\[
  D'(x) = \Lambda\Bigl[\tfrac14\operatorname{sech}^2\tfrac{x}{2}\,\Lambda
          + \tanh\tfrac{x}{2}\,\Lambda' - \Lambda\Bigr] .
\]
Write $y = x/2$, $S = \sinh y$, $C = \cosh y$, so that
$\Lambda = 2SC - 2y$ and $\Lambda' = 2S^2$. Multiplying the bracket by
$2C^2$ gives $(SC-y) + 4S^3C - 4SC^3 + 4yC^2$, and since
$S^3 - SC^2 = S(S^2-C^2) = -S$ the two cubic terms collapse to $-4SC$,
leaving
\[
  y(4C^2-1) - 3SC = y(3+4S^2) - 3SC .
\]
With $4S^2 = 2\cosh2y - 2$ and $2SC = \sinh 2y$, and putting $z = 2y$,
this is $\tfrac12\bigl[z(1+2\cosh z) - 3\sinh z\bigr]$. So everything
reduces to
\[
  \phi(z) \triangleq z + 2z\cosh z - 3\sinh z \;\ge\; 0 ,
\]
and $\phi(0) = 0$, $\phi'(z) = 1 - \cosh z + 2z\sinh z$ with
$\phi'(0) = 0$, and
\[
  \phi''(z) = \sinh z + 2z\cosh z \;\ge\; 0
  \qquad (z\ge0).
\]
Two integrations from zero give $\phi'\ge0$ then $\phi\ge0$, hence
$D'\ge0$, hence $D\ge0$. $\square$
