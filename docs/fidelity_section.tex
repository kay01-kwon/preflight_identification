...
the window midpoint the forcing is below $1\%$ of its edge value, so
propagating the actual profile through \eqref{eq:duhamel-bound}
tightens the uniform bound by a factor $25$--$96$.
